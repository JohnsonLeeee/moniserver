...
class MessageCore622(object):
    ...
    def c2s0000(self,bidnumber):
        ...
        checkcode = encutil.one_time_md5(bidnumber + self.CLIENT_ID + requestid + self.TIMESPAN + timestamp + self.VERSION)
    ...
    def s2c0202(self,responsecode,responsemsg,bidamount,bidnumber,msg,bidcount,requestid,dealtime,stype="1",code="0"):
        #in queue message
        servertime = time2str(dt.datetime.now())
...
def test2():
    ...
    mc.c2s0202('12345678', '84100', '1234', imageResponcode = 0, priceCode = '9b9', timestamp = '15144759', requestid = '12345678.f15144759')
